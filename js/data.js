...
// Libellé affiché sur la fiche de chaque personnage, par espèce.
...
export const PERSONNAGES = [
  ...
  },
  {
    ...
    nom: "Zecora",
    espece: "zebre",
    couleurs: { robe: "#dcd6de", rayures: "#5b5b66", criniere: ["#4a4a55", "#e8e5ec"], yeux: "#4fa8a0", or: "#e9c642" },
  ...
  },
  {
    ...
    espece: "alicorne",
    couleurs: { robe: "#fdfdff", criniere: ["#9be0dc", "#8fcaf0", "#f8b3c9", "#dfa8f7"], yeux: "#b07fce", or: "#f7c55c" },
  ...
  },
  {
    ...
    nom: "Princesse Luna",
    espece: "alicorne",
    couleurs: { robe: "#383e7c", criniere: ["#2748bd", "#6a86e8"], yeux: "#9fe6e2", argent: "#d8dcee" },
  ...
  },
  {
    ...
    nom: "Trixie",
    espece: "licorne",
    couleurs: { robe: "#7fbee9", criniere: ["#d3dcea", "#adb8cf"], yeux: "#c14fb0", cape: "#6157b5" },
  ...
  },
  {
    ...
    nom: "Cheerilee",
    espece: "terrestre",
    couleurs: { robe: "#bf5895", criniere: ["#f4a0cc", "#f8d2e8"], yeux: "#8ed267" },
  ...
  },
  {
    ...
    nom: "Gummy",
    espece: "alligator",
    couleurs: { robe: "#55cb54", ventre: "#c8f6a9", criniere: [], yeux: "#a95cf5" },
    cutieMark: null,
    lieuId: "sugarcube-corner",
  ...
  },
  {
    ...
    nom: "Winona",
    espece: "chien",
    couleurs: { robe: "#946243", blanc: "#fbf8f2", criniere: [], yeux: "#1f1a17" },
    cutieMark: null,
    lieuId: "sweet-apple-acres",
  ...
  },
  {
    ...
    nom: "Opale",
    espece: "chat",
    couleurs: { robe: "#e7ebef", criniere: ["#b89fc7"], yeux: "#c9e880", noeud: "#a177b3" },
    cutieMark: null,
    lieuId: "carousel-boutique",
  ...
  },
  {
    ...
    nom: "Owlowiscious",
    espece: "hibou",
    couleurs: { robe: "#95653c", ventre: "#e9ddb2", criniere: [], yeux: "#f2c14e" },
    cutieMark: null,
    lieuId: "bibliotheque",
